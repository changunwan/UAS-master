...
public class Main4Activity extends AppCompatActivity implements DapatkanAlamatTask.onTaskSelesai {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) { // function digunakn saat merestore data yang ada dalam Instancestate kedalam object yandg ditentukan
        ...
        {
            mLocationTextView.setText(getString(com.example.asus.myapplication.R.string.alamat_text,savedInstanceState.getString("placeName"),savedInstanceState.getString("placeAddress"), System.currentTimeMillis()));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.asus.myapplication.R.layout.activity_main4);

        mPlaceDetectionClient = Places.getPlaceDetectionClient(this);
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(this);
        mLocationTextView = (TextView) findViewById(com.example.asus.myapplication.R.id.textMap);
        btn = (Button) findViewById(com.example.asus.myapplication.R.id.btn);
        btnlokasi =(Button) findViewById(com.example.asus.myapplication.R.id.lokasi);
        mAndroidImageView = (ImageView) findViewById(com.example.asus.myapplication.R.id.image_view);
...
//                mulaiTrackingLokasi();
                ...
                mLocationTextView.setText(getString(com.example.asus.myapplication.R.string.alamat_text,
...
//            Log.d("GETPERMISSION", "getLocation : permission granted");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK){
            ...
            setTipeLokasi(place);
            mLocationTextView.setText(
                    getString(com.example.asus.myapplication.R.string.alamat_text,
                            place.getName(),
                            place.getAddress(),
                            System.currentTimeMillis())
            );
        ...
        for(Integer placeType : currentPlace.getPlaceTypes()){
            switch (placeType){
                case Place.TYPE_CAR_DEALER:
                    drawableID = com.example.asus.myapplication.R.drawable.daeler;
                    break;

            }
        }
        if (drawableID < 0){
            drawableID = com.example.asus.myapplication.R.drawable.oops;
        }
