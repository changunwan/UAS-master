...
public class MainActivity_Video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.asus.myapplication.R.layout.layoutvideo);

        videoView = (VideoView) findViewById(com.example.asus.myapplication.R.id.videoView);
        listView =  (ListView) findViewById(com.example.asus.myapplication.R.id.listView);

        textLoading = (TextView) findViewById(com.example.asus.myapplication.R.id.textLoading);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                datavideo datavideo = com.example.asus.myapplication.datavideo.drama[(int )id];
