...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.asus.myapplication.R.layout.activity_main2);

        MyFirebaseMessagingService ambilToken= new MyFirebaseMessagingService();

        ambilToken.onTokenRefresh();

        tvjudul = (TextView) findViewById(com.example.asus.myapplication.R.id.tvjudul);
        tvisi = (TextView) findViewById(com.example.asus.myapplication.R.id.tvisi);
