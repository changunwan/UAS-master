...
public class MainActivity extends AppCompatActivity implements ResepListFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.asus.myapplication.R.layout.activity_main);
    }
//
...
//    }
        ...
        View fragmentContainer = findViewById(com.example.asus.myapplication.R.id.detail_frag);
        if(fragmentContainer != null){
            ...
            ft.replace(com.example.asus.myapplication.R.id.detail_frag, details);
